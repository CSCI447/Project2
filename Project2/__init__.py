...
inputArray = []
expectedOutputArray = []
with codecs.open('NeuralNetwork/Data/4_dim.csv', 'r', encoding='utf-8') as inputcsvfile:
    csv_input = csv.reader(inputcsvfile, delimiter=",")
    for row in csv_input:
        #print(type(row[0]))
        inputArray.append(row)

with codecs.open('NeuralNetwork/Data/4_dim_out.csv', 'r', encoding='utf-8') as outputcsvfile:
